...
exports.MockPlacesAdapter = void 0;
class MockPlacesAdapter {
    async search(keyword) {
        ...
        const matches = indianPlaces.filter((p) => p.name.toLowerCase().includes(keywordLower) ||
...
exports.MockPlacesAdapter = MockPlacesAdapter;
